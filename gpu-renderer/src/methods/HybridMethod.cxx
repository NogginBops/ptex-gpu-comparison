...
namespace Methods {
	...
	void HybridMethod::init(int width, int height, gl_ptex_data data, GLenum mag_filter, GLenum min_filter, int max_anisotropy) {
		ptex_data = data;
	...
	void HybridMethod::render(GLuint vao, int vertex_count, mat4_t mvp, vec3_t bg_color)
	{
