...
uniform sampler2DArray aTex[16];
...
vec4 ptexture_single(sampler2DArray tex[16], vec2 uv, uint texIDsliceID)
{
...
vec3 ptexture(sampler2DArray tex[16], vec2 uv, int faceID)
{
